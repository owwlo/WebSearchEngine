...
class EchoHandler implements HttpHandler {
    public void handle(HttpExchange exchange) throws IOException {
        ...
        responseBody.write((responseHandle(exchange.getRequestURI()) + "\n").getBytes());
        responseBody.close();
    }

    private String responseHandle(URI uri) {
        ...
        return "Usage: \"localhost:" + EchoServer.port + "/search?query=test query\"\n";
    }
}
